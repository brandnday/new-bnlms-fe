    ...
    this.props.form.validateFieldsAndScroll(async (err, values) => {
      if(!err){
        ...
        if (this.props.editingIndex===-1){
          ...
          this.props.updateChurch({...values,editingId:this.props.churchList[this.props.editingIndex].id})
        }
            ...
            <Col span={18}>
              ...
              <Form.Item {...formItemLayout} label="churchname">
                  {getFieldDecorator("churchname", {
                    initialValue: editingIndex>=0?churchList[editingIndex].churchname:'',
                    rules: this.requiredRules("churchname")
                  })(<Input />)}
                </Form.Item>
                <Form.Item {...formItemLayout} label="description">
                  {getFieldDecorator("description", {
                    initialValue: editingIndex>=0?churchList[editingIndex].description:'',
